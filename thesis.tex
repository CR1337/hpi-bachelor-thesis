...
\newcommand{\hpititle}{Vergleich von regelmäßigen, randomisierten und bedarfsorientierten Abfahrtsplänen von Zügen im Kontext einer Verkehrssimulation}
\newcommand{\hpititleother}{Comparison of regular, randomized, and on-demand train departure schedules in the context of a traffic simulation} % <= das Studienreferat verlangt einen deutschen UND englischen Titel
