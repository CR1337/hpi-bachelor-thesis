...
\begin{figure}[!ht]
	...
	\caption{Klassendiagramm des \emph{Observer Patterns}. \code{Subscriber} können beim \code{Publisher} registiert werden, um Nachrichten über Ereignisse zu erhalten. Wird ein Ereignis ausgelöst, so informiert der \code{Publisher} alle registierten \code{Subscriber} darüber. \cite{skobeleva_observer_2023}}
